        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center fw-medium">
                ...
                <li class="nav-item ms-lg-3 mt-3 mt-lg-0 mb-2 mb-lg-0">
                    <a class="btn btn-light border px-4 me-lg-2 w-100" href="login.php">Ingresar</a>
                </li>
                <li class="nav-item w-100 w-lg-auto">
                    <a class="btn btn-primary-custom w-100" href="registro.php">Probar Gratis</a>
                </li>
            </ul>
        </div>
    </div>
...
<main class="container-fluid p-0">
    ...
    <!-- SECCIÓN COMPARATIVA (CAOS VS CLARIDAD) -->
    ...
    <!-- NUEVA SECCIÓN: COMPATIBILIDAD HARDWARE -->
    ...
    <!-- NUEVA SECCIÓN: FAQ (PREGUNTAS FRECUENTES) -->
    ...
    <!-- NUEVA SECCIÓN: LLAMADO A LA ACCIÓN FINAL (CTA) -->
